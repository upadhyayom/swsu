...
function skinluxe_product_catalog() {
	return array(
		...
		array(
			'title'        => 'Caffeine & Peptides Brightening Eye Cream - 15ml',
			'sku'          => 'SLX-EC-CAF-15',
			'price'        => 45.00,
			'size'         => '15ml',
			'short'        => 'Depuffing and illuminating cream for the delicate eye area.',
			'line'         => 'Face',
			'concerns'     => array( 'Aging', 'Pigmentation' ),
			'ingredients'  => array( 'Caffeine', 'Peptides' ),
			'image'        => 'https://images.unsplash.com/photo-1629598425232-a567ea3dfce9?auto=format&fit=crop&w=800&q=80',
		),
		array(
			'title'        => 'Invisible Shield SPF 50 Mineral Sunscreen - 50ml',
			'sku'          => 'SLX-SS-MIN-50',
			'price'        => 38.00,
			'size'         => '50ml',
			'short'        => 'Weightless, sheer protection against UVA/UVB without the white cast.',
			'line'         => 'Face',
			'concerns'     => array( 'Aging', 'Pigmentation' ),
			'ingredients'  => array( 'Zinc Oxide', 'Niacinamide' ),
			'image'        => 'https://images.unsplash.com/photo-1555820598-c801c13d7899?auto=format&fit=crop&w=800&q=80',
		),
		array(
			'title'        => 'Hydrating Rose Petal Lip Balm - 10g',
			'sku'          => 'SLX-LB-ROS-10',
			'price'        => 18.00,
			'size'         => '10g',
			'short'        => 'Deep conditioning balm for visibly plumper, softer lips.',
			'line'         => 'Face',
			'concerns'     => array( 'Dryness' ),
			'ingredients'  => array( 'Shea Butter', 'Vitamin E' ),
			'image'        => 'https://images.unsplash.com/photo-1596462502278-27bf85033e5a?auto=format&fit=crop&w=800&q=80',
		),
	);
}
